...
from python.src.structures import Instances, Boxes
from python.src.utils import cat, batched_nms, is_tracing
...
def add_ground_truth_to_proposals(
    ...
    :param gt_boxes: list of N elements. Element i is a Boxes representing the gound-truth for image i.
    :param proposals: list of N elements. Element i is a Instances representing the proposals for image i.
    :return:  list of N Instances. Each is the proposals for the image, with field "proposal_boxes" and
    "objectness_logits".
    """
